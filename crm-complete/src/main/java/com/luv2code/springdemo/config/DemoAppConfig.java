...
@ComponentScan("com.luv2code.springdemo,com.luv2code.springsecurity")
...
public class DemoAppConfig implements WebMvcConfigurer {
	...
	@Bean
	@Autowired
	public HibernateTransactionManager customerTransactionManager(@Qualifier(value="customerSessionFactory") SessionFactory sessionFactory) {
	...
	public LocalSessionFactoryBean userSessionFactory(){
		...
		sessionFactory.setPackagesToScan(env.getProperty("securityhibernate.packagesToScan"));
		sessionFactory.setHibernateProperties(getHibernateProperties());
	...
	@Primary
	@Autowired
	public HibernateTransactionManager userTransactionManager(@Qualifier(value="userSessionFactory") SessionFactory sessionFactory) {
